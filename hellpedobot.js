...
avgVoteRatioCommand, chatCommandDispatcher, chatUniversals, cmds, data, dieCommand, disconnectLookupCommand, fans, 

handleNewSong, handleUserJoin, handleUserLeave, handleVote, hook, initEnvironment, initHooks, initialize, lockCommand, 

lockskipCommand, msToStr, newSongsCommand, newsCommand, populateUserData, channelCommand, pupOnline, reloadCommand, 

removeCommand, roomHelpCommand, rulesCommand, settings, skipCommand, staffCommand, statusCommand, themeCommand, undoHooks, 

unhook, unlockCommand, updateVotes, versionCommand, voteRatioCommand, _ref, _ref1, _ref10, _ref11, _ref12, _ref13, _ref14, 

_ref15, _ref16, _ref17, _ref18, _ref19, _ref2, _ref20, _ref21, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
...
item) return i; } return -1; },
    ...
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent

[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); 
...
child.__super__ = parent.prototype; return child; };
    ...
    settings.prototype.songIntervalMessages = [
      {
        interval: 7,
        offset: 0,
        msg: "Add: https://www.facebook.com/Alsfallen"
      }, {
        interval: 5,
        offset: 0,
  ...
  pupOnline = function() {
    ...
    log("BOT editado por ALS " + currentversion + " Nois que Tá ");
  ...
  afkCheck = function() {
    var DJs, id, lastActivity, lastWarned, now, secsLastActive, timeSinceLastActivity, timeSinceLastWarning, twoMinutes, 
      ...
      if (timeSinceLastActivity > data.afkTime) {
        if (user.getIsDj()) {
          ...
          if (user.getWarningCount() === 0) {
            user.warn();
            _results.push(API.sendChat("@" + user.getUser().username + ", Você não falou no chat nos ultimos 30 minutos, por 

favor fale alguma coisa em 4 minutos ou será kickado da line de dj."));
  ...
  newSongsCommand = (function(_super) {
    ...
    newSongsCommand.prototype.functionality = function() {
      ...
      msg = "Querem musica de Dubstep do " + selections['artist'] + " entre! Tem musicas nova sempre em http://youtube.com/" 

+ selections['channels'][0] + " http://youtube.com/" + selections['channels'][1] + " ou http://youtube.com/" + selections

['channels'][2];
      return API.sendChat(msg);
    };

    newSongsCommand.prototype.memberChannels = ["MistaDubstep", "DubStationPromotions", "UndergroundDubstep", 

"JesusDied4Dubstep", "DarkstepWarrior", "BombshockDubstep", "Sharestep"];

    newSongsCommand.prototype.channels = ["BassRape", "MonstercatMedia", "UKFdubstep", "DropThatBassline", "VitalDubstep", 

"AirwaveDubstepTV", "InspectorDubplate", "TehDubstepChannel", "UNITEDubstep", "LuminantNetwork", "TheSoundIsle", 

"PandoraMuslc", "MrSuicideSheep", "HearTheSensation", "bassoutletpromos", "MistaDubstep", "DubStationPromotions", 

"UndergroundDubstep", "JesusDied4Dubstep", "DarkstepWarrior", "BombshockDubstep", "Sharestep"];

    newSongsCommand.prototype.artists = ["Doctor P", "Excision", "Flux Pavilion", "Knife Party", "Rusko", "Bassnectar", 

"Nero", "Deadmau5", "Borgore", "Zomboy"];
  ...
  themeCommand = (function(_super) {
    ...
    themeCommand.prototype.functionality = function() {
      ...
      msg = "Temas permitidos aqui na sala. electro, rap, ";
  ...
  afksCommand = (function(_super) {
    ...
    afksCommand.prototype.functionality = function() {
      ...
      if (msg === '') {
        return API.sendChat("Não tem ninguém ausente.");
      } else {
        return API.sendChat('Ausentes: ' + msg);
      }
    };
  ...
  dieCommand = (function(_super) {
    ...
    dieCommand.prototype.functionality = function() {
      API.sendChat("Bot será desligado ");
      undoHooks();
      API.sendChat("3,2,1");
      data.implode();
      return API.sendChat("BOT OFF[x] on [ ]");
    };
  ...
  disconnectLookupCommand = (function(_super) {
    ...
    disconnectLookupCommand.prototype.functionality = function() {
      var cmd, dcHour, dcLookupId, dcMeridian, dcMins, dcSongsAgo, dcTimeStr, dcUser, disconnectInstances, givenName, id, 

recentDisconnect, resp, u, _i, _len, _ref16, _ref17;
  ...
  avgVoteRatioCommand = (function(_super) {
    ...
    avgVoteRatioCommand.prototype.functionality = function() {
      ...
      msg = "Accounting for " + roomRatios.length.toString() + " user ratios, the average room ratio is " + 

averageRatio.toFixed(2).toString() + ".";
      return API.sendChat(msg);
    };
  ...
  channelCommand = (function(_super) {
    ...
    channelCommand.prototype.functionality = function() {
      return API.sendChat("/em: lisa de comandos em breve :) ");
    };
  ...
  versionCommand = (function(_super) {
    ...
    versionCommand.prototype.functionality = function() {
      return API.sendChat("/me BOT editado por ALS  " + currentversion);
    };
  ...
  cmds = [newSongsCommand, themeCommand, rulesCommand, roomHelpCommand, afksCommand, allAfksCommand, statusCommand, 

dieCommand, reloadCommand, lockCommand, unlockCommand, removeCommand, addCommand, skipCommand, disconnectLookupCommand, 

voteRatioCommand, avgVoteRatioCommand, staffCommand, lockskipCommand, versionCommand, newsCommand, channelCommand];
  ...
  handleNewSong = function(obj) {
    ...
    if (data.currentsong === null) {
      ...
      API.sendChat("/em: " + data.currentsong.title + " por " + data.currentsong.author + ". :+1: " + data.currentwoots + ", 

:-1: " + data.currentmehs + ", :heart: " + data.currentcurates + ".");
      data.newSong();
      document.getElementById("button-vote-positive").click();
    }
    if (data.forceSkip) {
  ...
  fans = function(chat) {
    ...
    if (msg.indexOf('eowkreowr') !== -1 || msg.indexOf('dsjaodas') !== -1 || msg.indexOf('poekpower') !== -1 || msg.indexOf

('fokdsofsdpof') !== -1 || msg.indexOf(':trollface:') !== -1 || msg.indexOf('autowoot:') !== -1) {
      return API.moderateDeleteChat(chat.chatID);
    }
  };
